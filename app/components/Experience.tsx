      ...
      <div className="flex flex-wrap items-center">
        ...
        <div className="w-full mt-10 sm:mt-0 sm:pl-2 sm:flex-1">
          <div>
            ...
            <p className="text-justify">Working as a Software Engineer in web development related domains. Supporting Dorca Software Ltd. (Ireland) and several private Clients (Poland).<br /><strong>Main tasks</strong>: developing front-end and back-end applications (web based learning platform for traders), developing mobile/wearable applications (application for Garmin Watch devices), configuring integration with Digital Ocean back-end infrastructure, configuring Nginx bastion to support full application deployment and security, developing Python programs to support large data sets parsing (Numpy, Scipy, Matplotlib), Python scripts including web scrapping (Selenium). Linux's systems administration. Automating data collecting processes. Automate large data set update processes (creating XML files and uploading data to PrestaShop).<br /><strong>Technologies used</strong>: Node.js, Next.js, Django, Nginx, REST, InfluxDB, MySQL, Python, PHP, Git, monkey C.</p>
