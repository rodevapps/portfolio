    ...
    <section className="px-1 xs:px-3 sm:px-5 py-20 dark:bg-black dark:text-white">
      <div className="flex flex-wrap">
        <div className="skills w-full sm:flex-1 sm:pr-2 mx-auto max-w-xl">
          ...
          <div className="flex justify-between mb-1 mt-10">
            <span className="text-base font-medium">Angular 2+</span>
            <span className="text-sm font-medium">30%</span>
          </div>
          <div className="w-full bg-gray-200 h-3 dark:bg-gray-700">
            <div className="bg-red-600 h-3" style={{ width: '30%' }}></div>
          ...
          <p className="mt-10 text-justify">These are a selected technologies which I have used recently. I have also experience with Awk, Ruby, C/C++, PHP, Groovy, Java, C#, MongoDB. I also have theoretical knowledge of the basics of many other technologies such as Ansible, Jenkins, Terraform, Kubernetes, Helm. In the future I would like to become more familiar with Go, Scala and Rust etc.</p>
